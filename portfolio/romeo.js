...
function bi_hide(){
    ...
    vbi_d[0].className='ptp con';
     vbi_d[1].className='ptp con';
     vbi_d[2].className='ptp con';
     vbi_d[3].className='ptp con';
     vbi_d[4].className='ptl con';
     vbi_d[5].className='ptl con';
       vbi_d[6].className='ptl con';
     vbi_d[7].className='ptl con';
     vbi_d[8].className='ptp con';
     vbi_d[9].className='ptp con';
     vbi_d[10].className='ptp con';
     vbi_d[11].className='ptp con';
       vbi_d[12].className='ptp con';
     vbi_d[13].className='ptp con';
     vbi_d[14].className='ptp con';
     vbi_d[15].className='ptp con';
    ...
    vbi_d[22].className='ptl con';  vbi_d[23].className='ptl con';
...
vbi_m[1].addEventListener('click',function(){bi_fun(1,1);}, false);
vbi_m[2].addEventListener('click',function(){bi_fun(2,1);}, false);
vbi_m[3].addEventListener('click',function(){bi_fun(3,1);}, false);
vbi_m[4].addEventListener('click',function(){bi_fun(4,0);}, false);
vbi_m[5].addEventListener('click',function(){bi_fun(5,0);}, false);
...
vbi_m[10].addEventListener('click',function(){bi_fun(10,1);}, false);
vbi_m[11].addEventListener('click',function(){bi_fun(11,1);}, false);
vbi_m[12].addEventListener('click',function(){bi_fun(12,1);}, false);
vbi_m[13].addEventListener('click',function(){bi_fun(13,1);}, false);
vbi_m[14].addEventListener('click',function(){bi_fun(14,1);}, false);
vbi_m[15].addEventListener('click',function(){bi_fun(15,1);}, false);
