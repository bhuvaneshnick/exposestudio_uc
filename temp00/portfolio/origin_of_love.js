...
vbi_m[0].addEventListener('click',function(){bi_fun(0,0);}, false);
...
vbi_m[8].addEventListener('click',function(){bi_fun(8,0);}, false);
vbi_m[9].addEventListener('click',function(){bi_fun(9,0);}, false);
...
vbi_m[14].addEventListener('click',function(){bi_fun(14,0);}, false);
vbi_m[15].addEventListener('click',function(){bi_fun(15,0);}, false);
vbi_m[16].addEventListener('click',function(){bi_fun(16,0);}, false);
vbi_m[17].addEventListener('click',function(){bi_fun(17,0);}, false);
vbi_m[18].addEventListener('click',function(){bi_fun(18,0);}, false);
vbi_m[19].addEventListener('click',function(){bi_fun(19,0);}, false);
vbi_m[20].addEventListener('click',function(){bi_fun(20,1);}, false);
vbi_m[21].addEventListener('click',function(){bi_fun(21,1);}, false);
vbi_m[22].addEventListener('click',function(){bi_fun(22,1);}, false);
vbi_m[23].addEventListener('click',function(){bi_fun(23,1);}, false);
